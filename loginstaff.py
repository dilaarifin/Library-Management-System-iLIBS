...
def login():
    ...
    query = "SELECT * FROM staff WHERE staff_user = ? AND staff_pass = ?"
...
window = tk.Tk()
window.title("Welcome to iLIBS: Login Staff")
...
login_label = tkinter.Label(frame, text="LOGIN STAFF", font=("Arial", 30, "bold"))
